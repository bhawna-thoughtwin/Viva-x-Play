...
const ResponsibleGaming = () => {
  return (
    <div className="w-full max-w-[1188px] bg-[#f5f7fb] rounded-[12px] overflow-hidden shadow-[0_4px_18px_rgba(15,23,42,0.06)] mx-auto">
      <PageHeader title="Responsible Gaming Policy" breadcrumb />
      ...
      >
        ...
        <ul className="list-disc pl-6 text-[14px] leading-[150%] text-[#4b5563] mb-2 max-w-[900px] space-y-[6px]">
          <li>Responsible gaming procedures are reviewed annually.</li>
          <li>Staff training, documentation, and enforcement actions are recorded.</li>
          <li>Records are available to the regulator upon request.</li>
          <li>Updates to this policy are submitted to the regulator where required.</li>
        </ul>
        ...
        <ul className="list-disc pl-6 text-[14px] leading-[150%] text-[#4b5563] mb-2 max-w-[900px] space-y-[6px]">
          <li>Set a budget before playing and respect it.</li>
          <li>Avoid chasing losses.</li>
          <li>Only play with money you can afford to lose.</li>
          <li>Take regular breaks to avoid excessive sessions.</li>
          <li>Avoid gaming when tired, stressed, or under the influence.</li>
          <li>
        ...
        <ul className="list-disc pl-6 text-[14px] leading-[150%] text-[#4b5563] mb-2 max-w-[900px] space-y-[6px]">
          ...
          <li>No deposits or wagers can be made.</li>
          <li>Pending wagers settle normally.</li>
          <li>Players are removed from all promotional communications.</li>
          <li>Permanent exclusions are final.</li>
        </ul>
        <p className="text-[14px] leading-[150%] text-[#4b5563] mb-2 max-w-[900px]">
        ...
        <ul className="list-disc pl-6 text-[14px] leading-[150%] text-[#4b5563] mb-2 max-w-[900px] space-y-[6px]">
          <li>Excessive or rapid deposits.</li>
          <li>Prolonged continuous play.</li>
          <li>Erratic or compulsive betting patterns.</li>
          <li>Multiple failed deposit attempts.</li>
          <li>Signs of financial or emotional distress.</li>
        </ul>
        <p className="text-[14px] leading-[150%] text-[#4b5563] mb-2 max-w-[900px]">
          If concerning indicators appear, TigerBet247 may:
        </p>
        <ul className="list-disc pl-6 text-[14px] leading-[150%] text-[#4b5563] mb-2 max-w-[900px] space-y-[6px]">
          <li>Contact the player with guidance and support.</li>
          <li>Recommend setting limits or taking time out.</li>
          <li>Apply mandatory cooling-off periods.</li>
          <li>Impose account restrictions or suspensions.</li>
          <li>Enforce permanent exclusion if necessary.</li>
        </ul>
        <p className="text-[14px] leading-[150%] text-[#4b5563] mb-2 max-w-[900px]">
        ...
        <ul className="list-disc pl-6 text-[14px] leading-[150%] text-[#4b5563] mb-2 max-w-[900px] space-y-[6px]">
          <li>Identifying problem gambling indicators.</li>
          <li>Processing limit and exclusion requests correctly.</li>
          <li>Interacting sensitively with at-risk players.</li>
          <li>Escalation and reporting procedures.</li>
        </ul>
        <p className="text-[14px] leading-[150%] text-[#4b5563] mb-2 max-w-[900px]">
        ...
        <ul className="list-disc pl-6 text-[14px] leading-[150%] text-[#4b5563] mb-2 max-w-[900px] space-y-[6px]">
          <li>No promotions target minors or vulnerable individuals.</li>
          <li>Self-excluded players do not receive promotional materials.</li>
          <li>
            Advertising never suggests gambling as a financial solution or path to success.
          </li>
          <li>All promotions include clear and transparent terms.</li>
        </ul>
        <p className="text-[14px] leading-[150%] text-[#4b5563] mb-2 max-w-[900px]">
        ...
        <h2 className="text-[20px] md:text-[24px] font-bold leading-[100%] tracking-[0em] text-[#111827] mt-6 mb-2">
          10. Fair Gaming and RTP Disclosure
        </h2>
        <p className="text-[14px] leading-[150%] text-[#4b5563] mb-2 max-w-[900px]">
        ...
        <ul className="list-disc pl-6 text-[14px] leading-[150%] text-[#4b5563] mb-2 max-w-[900px] space-y-[6px]">
          ...
          <li>Random Number Generators (RNGs) are audited periodically.</li>
          <li>
        ...
        <ul className="list-disc pl-6 text-[14px] leading-[150%] text-[#4b5563] mb-2 max-w-[900px] space-y-[6px]">
          <li>
            <strong>Gambling Therapy</strong> – <a href="https://www.gamblingtherapy.org" className="text-[#025877] no-underline" target="_blank" rel="noopener noreferrer">www.gamblingtherapy.org</a>
          </li>
          <li>
            <strong>GamCare</strong> – <a href="https://www.gamcare.org.uk" className="text-[#025877] no-underline" target="_blank" rel="noopener noreferrer">www.gamcare.org.uk</a>
          </li>
          <li>
            <strong>Gamblers Anonymous</strong> – <a href="https://www.gamblersanonymous.org" className="text-[#025877] no-underline" target="_blank" rel="noopener noreferrer">www.gamblersanonymous.org</a>
          </li>
        </ul>
        <p className="text-[14px] leading-[150%] text-[#4b5563] mb-2 max-w-[900px]">
