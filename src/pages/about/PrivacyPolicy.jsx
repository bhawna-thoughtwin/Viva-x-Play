...
const PrivacyPolicy = () => {
  return (
    <div className="w-full max-w-[1188px] bg-[#f5f7fb] rounded-[12px] overflow-hidden shadow-[0_4px_18px_rgba(15,23,42,0.06)] mx-auto">
      <PageHeader title="Privacy Policy" breadcrumb />
      ...
      >
        ...
        <ol className="list-decimal pl-5 text-[14px] text-[#111827] mb-4 max-w-[900px] space-y-3">

          <li className="font-semibold text-[16px]">
            <h3 className="text-[20px] md:text-[20px] font-bold leading-[100%] tracking-[0em] text-[#111827] mt-2 mb-2">
              Personal Information
            </h3>
            <p className="text-[14px] leading-[150%] text-[#4b5563] mb-2 font-normal">
              We may request information that can be used to identify or contact you. This may
              include, but is not limited to:
            </p>
            <ul className="list-disc pl-6 text-[14px] leading-[150%] text-[#4b5563] mb-2 space-y-[4px] font-normal">
              <li>Email address</li>
              <li>First and last name</li>
              <li>Phone number</li>
              <li>Residential address, city, province/state, ZIP or postal code</li>
              <li>Date of birth</li>
              <li>Payment information and transaction details required to process deposits and withdrawals</li>
              <li>Identification documents required for verification</li>
              <li>Account security information such as login credentials</li>
            </ul>
            <p className="text-[14px] leading-[150%] text-[#4b5563] mb-2 font-normal">
            ...
            <ul className="list-disc pl-6 text-[14px] leading-[150%] text-[#4b5563] mb-2 space-y-[4px] font-normal">
              ...
              <li>Utility bill</li>
              <li>Bank card or bank statement</li>
              <li>Documentation linking you to a residential address</li>
            </ul>
          </li>
          ...
          <li className="font-semibold text-[16px]">
            ...
            <ul className="list-disc pl-6 text-[14px] leading-[150%] text-[#4b5563] mb-2 space-y-[4px] font-normal">
              ...
              <li>Website navigation behavior and activity</li>
            </ul>
          </li>
        ...
        <ul className="list-disc pl-6 text-[14px] leading-[150%] text-[#4b5563] mb-2 max-w-[900px] space-y-[6px]">
          ...
          <li>To process deposits, withdrawals, and other financial transactions</li>
          <li>To provide customer support and respond to inquiries</li>
          <li>To comply with legal, regulatory, and anti-money laundering obligations</li>
          <li>To personalize your experience and deliver relevant content</li>
          <li>To communicate with you regarding your account, updates, security alerts, and promotional information</li>
          <li>To detect, prevent, and investigate fraud, abuse, or illegal activities</li>
          <li>To produce internal analytics or aggregated data for business and compliance purposes</li>
        </ul>
