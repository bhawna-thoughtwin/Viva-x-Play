...
const FreeSpinBonus = () => (
  <section className="w-full max-w-full mb-1 md:mb-4 box-border relative">
    ...
    >
      ...
      {/* LEFT — freespin image — MOBILE only */}
      <img
        src={freeSpinImg}
        alt="Free spin"
        className="absolute object-contain pointer-events-none z-[1] md:hidden"
        style={{
          top: '44px',
          left: '-61px',
          width: '223px',
      ...
      {/* LEFT — freespin image — DESKTOP only */}
      <img
        src={freeSpinImg}
        alt="Free spin"
        className="absolute object-contain pointer-events-none z-[1] hidden md:block"
        style={{
          top: '-20px',
          left: '-65px',
          width: '594px',
