  ...
  <div className="shrink-0 w-[338px] h-[176px] bg-white border border-[#e5e7eb] rounded-[8px] px-4 py-3 flex flex-col justify-between cursor-pointer hover:border-[#1CD4FF] hover:shadow-sm transition-all box-border">
    ...
    <div className="flex gap-2">
      {odds.map((odd, i) => (
        ...
        >
          <span className="w-full text-center whitespace-nowrap overflow-hidden text-ellipsis" style={{ fontFamily: "'SF Pro', -apple-system, BlinkMacSystemFont, sans-serif", fontWeight: 590, fontSize: '14px', lineHeight: '100%', letterSpacing: '0%', color: '#6b7280' }}>{odd.label}</span>
